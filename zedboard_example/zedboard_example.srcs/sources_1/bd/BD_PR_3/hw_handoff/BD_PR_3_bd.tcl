...
################################################################
# This is a generated script based on design: BD_PR_3
#
...
proc create_hier_cell_Processing_System { parentCell nameHier } {
  ...
  create_bd_pin -dir I -from 0 -to 0 IRQ_0
  create_bd_pin -dir I -from 0 -to 0 IRQ_1
  create_bd_pin -dir I -from 0 -to 0 IRQ_2
  create_bd_pin -dir I -from 0 -to 0 IRQ_3
  create_bd_pin -dir I -from 0 -to 0 IRQ_4
  create_bd_pin -dir I -from 0 -to 0 IRQ_5
...
CONFIG.NUM_MI {3} \
  ...
  connect_bd_intf_net -intf_net Conn4 [get_bd_intf_pins S03_AXI] [get_bd_intf_pins axi_mem_intercon/S03_AXI]
  connect_bd_intf_net -intf_net Conn5 [get_bd_intf_pins S04_AXI] [get_bd_intf_pins axi_mem_intercon/S04_AXI]
  connect_bd_intf_net -intf_net Conn6 [get_bd_intf_pins S05_AXI] [get_bd_intf_pins axi_mem_intercon/S05_AXI]
  ...
  connect_bd_net -net axi_dma_0_mm2s_introut [get_bd_pins IRQ_0] [get_bd_pins IRQ_Concat/In0]
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins IRQ_1] [get_bd_pins IRQ_Concat/In1]
  connect_bd_net -net axi_dma_1_mm2s_introut [get_bd_pins IRQ_2] [get_bd_pins IRQ_Concat/In2]
  connect_bd_net -net axi_dma_1_s2mm_introut [get_bd_pins IRQ_3] [get_bd_pins IRQ_Concat/In3]
  connect_bd_net -net axi_dma_2_mm2s_introut [get_bd_pins IRQ_4] [get_bd_pins IRQ_Concat/In4]
  connect_bd_net -net axi_dma_2_s2mm_introut [get_bd_pins IRQ_5] [get_bd_pins IRQ_Concat/In5]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins FCLK_CLK0] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins axi_mem_intercon/S02_ACLK] [get_bd_pins axi_mem_intercon/S03_ACLK] [get_bd_pins axi_mem_intercon/S04_ACLK] [get_bd_pins axi_mem_intercon/S05_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_HP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/M02_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins S00_ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins axi_mem_intercon/S02_ARESETN] [get_bd_pins axi_mem_intercon/S03_ARESETN] [get_bd_pins axi_mem_intercon/S04_ARESETN] [get_bd_pins axi_mem_intercon/S05_ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/M02_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
...
proc create_root_design { parentCell } {
  ...
  set m_axis_data_1 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 m_axis_data_1 ]
  set m_axis_data_2 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 m_axis_data_2 ]
...
CONFIG.TUSER_WIDTH {0} \
  ...
  set s_axis_data_1 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 s_axis_data_1 ]
  set_property -dict [ list \
CONFIG.HAS_TKEEP {1} \
CONFIG.HAS_TLAST {1} \
CONFIG.HAS_TREADY {1} \
...
CONFIG.TUSER_WIDTH {0} \
  ...
  set s_axis_data_2 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 s_axis_data_2 ]
  set_property -dict [ list \
CONFIG.HAS_TKEEP {1} \
CONFIG.HAS_TLAST {1} \
CONFIG.HAS_TREADY {1} \
...
CONFIG.TUSER_WIDTH {0} \
  ...
  set_property -dict [ list \
CONFIG.ASSOCIATED_BUSIF {m_axis_data_0:m_axis_data_1:s_axis_data_0:s_axis_data_2:s_axis_data_1:m_axis_data_2} \
 ] $AXIS_CLK
...
CONFIG.c_sg_length_width {23} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_ports m_axis_data_0] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_MM2S [get_bd_intf_pins Processing_System/S00_AXI] [get_bd_intf_pins axi_dma_0/M_AXI_MM2S]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXI_S2MM [get_bd_intf_pins Processing_System/S01_AXI] [get_bd_intf_pins axi_dma_0/M_AXI_S2MM]
  connect_bd_intf_net -intf_net axi_dma_1_M_AXIS_MM2S [get_bd_intf_ports m_axis_data_1] [get_bd_intf_pins axi_dma_1/M_AXIS_MM2S]
  connect_bd_intf_net -intf_net axi_dma_1_M_AXI_MM2S [get_bd_intf_pins Processing_System/S02_AXI] [get_bd_intf_pins axi_dma_1/M_AXI_MM2S]
  connect_bd_intf_net -intf_net axi_dma_1_M_AXI_S2MM [get_bd_intf_pins Processing_System/S03_AXI] [get_bd_intf_pins axi_dma_1/M_AXI_S2MM]
  connect_bd_intf_net -intf_net axi_dma_2_M_AXIS_MM2S [get_bd_intf_ports m_axis_data_2] [get_bd_intf_pins axi_dma_2/M_AXIS_MM2S]
  connect_bd_intf_net -intf_net axi_dma_2_M_AXI_MM2S [get_bd_intf_pins Processing_System/S04_AXI] [get_bd_intf_pins axi_dma_2/M_AXI_MM2S]
  connect_bd_intf_net -intf_net axi_dma_2_M_AXI_S2MM [get_bd_intf_pins Processing_System/S05_AXI] [get_bd_intf_pins axi_dma_2/M_AXI_S2MM]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins Processing_System/M00_AXI] [get_bd_intf_pins axi_dma_0/S_AXI_LITE]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins Processing_System/M01_AXI] [get_bd_intf_pins axi_dma_1/S_AXI_LITE]
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M02_AXI [get_bd_intf_pins Processing_System/M02_AXI] [get_bd_intf_pins axi_dma_2/S_AXI_LITE]
  connect_bd_intf_net -intf_net s_axis_data_0_1 [get_bd_intf_ports s_axis_data_0] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net s_axis_data_1_1 [get_bd_intf_ports s_axis_data_1] [get_bd_intf_pins axi_dma_1/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net s_axis_data_2_1 [get_bd_intf_ports s_axis_data_2] [get_bd_intf_pins axi_dma_2/S_AXIS_S2MM]

  # Create port connections
  connect_bd_net -net axi_dma_0_mm2s_introut [get_bd_pins Processing_System/IRQ_0] [get_bd_pins axi_dma_0/mm2s_introut]
  connect_bd_net -net axi_dma_0_s2mm_introut [get_bd_pins Processing_System/IRQ_1] [get_bd_pins axi_dma_0/s2mm_introut]
  connect_bd_net -net axi_dma_1_mm2s_introut [get_bd_pins Processing_System/IRQ_2] [get_bd_pins axi_dma_1/mm2s_introut]
  connect_bd_net -net axi_dma_1_s2mm_introut [get_bd_pins Processing_System/IRQ_3] [get_bd_pins axi_dma_1/s2mm_introut]
  connect_bd_net -net axi_dma_2_mm2s_introut [get_bd_pins Processing_System/IRQ_4] [get_bd_pins axi_dma_2/mm2s_introut]
  connect_bd_net -net axi_dma_2_s2mm_introut [get_bd_pins Processing_System/IRQ_5] [get_bd_pins axi_dma_2/s2mm_introut]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_ports AXIS_CLK] [get_bd_pins Processing_System/FCLK_CLK0] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_dma_1/m_axi_mm2s_aclk] [get_bd_pins axi_dma_1/m_axi_s2mm_aclk] [get_bd_pins axi_dma_1/s_axi_lite_aclk] [get_bd_pins axi_dma_2/m_axi_mm2s_aclk] [get_bd_pins axi_dma_2/m_axi_s2mm_aclk] [get_bd_pins axi_dma_2/s_axi_lite_aclk]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins Processing_System/S00_ARESETN] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_dma_1/axi_resetn] [get_bd_pins axi_dma_2/axi_resetn]

  # Create address segments
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs Processing_System/processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs Processing_System/processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces axi_dma_1/Data_MM2S] [get_bd_addr_segs Processing_System/processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces axi_dma_1/Data_S2MM] [get_bd_addr_segs Processing_System/processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces axi_dma_2/Data_MM2S] [get_bd_addr_segs Processing_System/processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x20000000 -offset 0x00000000 [get_bd_addr_spaces axi_dma_2/Data_S2MM] [get_bd_addr_segs Processing_System/processing_system7_0/S_AXI_HP0/HP0_DDR_LOWOCM] SEG_processing_system7_0_HP0_DDR_LOWOCM
  create_bd_addr_seg -range 0x00010000 -offset 0x40400000 [get_bd_addr_spaces Processing_System/processing_system7_0/Data] [get_bd_addr_segs axi_dma_0/S_AXI_LITE/Reg] SEG_axi_dma_0_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x40410000 [get_bd_addr_spaces Processing_System/processing_system7_0/Data] [get_bd_addr_segs axi_dma_1/S_AXI_LITE/Reg] SEG_axi_dma_1_Reg
  create_bd_addr_seg -range 0x00010000 -offset 0x40420000 [get_bd_addr_spaces Processing_System/processing_system7_0/Data] [get_bd_addr_segs axi_dma_2/S_AXI_LITE/Reg] SEG_axi_dma_2_Reg

  # Perform GUI Layout
  regenerate_bd_layout -layout_string {
   guistr: "# # String gsaved with Nlview 6.6.5b  2016-09-06 bk=1.3687 VDI=39 GEI=35 GUI=JA:1.6
#  -string -flagsOSRD
preplace port DDR -pg 1 -lvl 1:60 -defaultsOSRD -top
preplace port s_axis_data_0 -pg 1 -y 200 -defaultsOSRD
preplace port m_axis_data_0 -pg 1 -y 230 -defaultsOSRD
preplace port s_axis_data_1 -pg 1 -y 480 -defaultsOSRD
preplace port m_axis_data_1 -pg 1 -y 490 -defaultsOSRD
preplace port AXIS_CLK -pg 1 -lvl 2:-140 -defaultsOSRD -top
preplace port s_axis_data_2 -pg 1 -y 680 -defaultsOSRD
preplace port m_axis_data_2 -pg 1 -y 690 -defaultsOSRD
preplace port FIXED_IO -pg 1 -lvl 1:80 -defaultsOSRD -top
preplace inst Processing_System|axi_mem_intercon -pg 1 -lvl 3 -y 920 -defaultsOSRD
preplace inst axi_dma_0 -pg 1 -lvl 2 -y 250 -defaultsOSRD
preplace inst Processing_System|rst_ps7_0_100M -pg 1 -lvl 2 -y 430 -defaultsOSRD
preplace inst axi_dma_1 -pg 1 -lvl 2 -y 510 -defaultsOSRD
preplace inst Processing_System|IRQ_Concat -pg 1 -lvl 1 -y 710 -defaultsOSRD
preplace inst axi_dma_2 -pg 1 -lvl 2 -y 750 -defaultsOSRD
preplace inst Processing_System|ps7_0_axi_periph -pg 1 -lvl 3 -y 470 -defaultsOSRD
preplace inst Processing_System -pg 1 -lvl 1 -y 410 -defaultsOSRD
preplace inst Processing_System|processing_system7_0 -pg 1 -lvl 2 -y 700 -defaultsOSRD
preplace netloc Processing_System|Conn2 1 0 3 NJ 350 420J 340 1000
preplace netloc s_axis_data_2_1 1 0 2 -70J 1220 1530J
preplace netloc processing_system7_0_DDR 1 1 1 1470
preplace netloc ps7_0_axi_periph_M02_AXI 1 1 1 1490
preplace netloc Processing_System|Conn3 1 0 3 NJ 520 NJ 520 980
preplace netloc axi_dma_1_M_AXI_S2MM 1 0 3 10 100 NJ 100 1990
preplace netloc axi_dma_2_s2mm_introut 1 0 3 30 1240 NJ 1240 1930
preplace netloc Processing_System|Conn4 1 0 3 NJ 540 NJ 540 970
preplace netloc Processing_System|processing_system7_0_DDR 1 2 2 930J 300 NJ
preplace netloc Processing_System|Conn5 1 0 3 NJ 560 NJ 560 950
preplace netloc Processing_System|ps7_0_axi_periph_M02_AXI 1 3 1 N
preplace netloc Processing_System|ps7_0_axi_periph_M00_AXI 1 3 1 N
preplace netloc Processing_System|processing_system7_0_FIXED_IO 1 2 2 NJ 640 1310J
preplace netloc Processing_System|axi_dma_0_s2mm_introut 1 0 1 N
preplace netloc Processing_System|rst_ps7_0_100M_interconnect_aresetn 1 2 1 910
preplace netloc axi_dma_1_M_AXI_MM2S 1 0 3 0 60 NJ 60 2020
preplace netloc axi_dma_1_M_AXIS_MM2S 1 2 1 NJ
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 1 1520
preplace netloc Processing_System|Conn6 1 0 3 NJ 580 420J 570 920
preplace netloc Processing_System|axi_mem_intercon_M00_AXI 1 1 3 430 280 NJ 280 1300
preplace netloc Processing_System|axi_dma_1_mm2s_introut 1 0 1 N
preplace netloc axi_dma_1_s2mm_introut 1 0 3 -30 120 NJ 120 1970
preplace netloc Processing_System|processing_system7_0_M_AXI_GP0 1 2 1 960
preplace netloc Processing_System|IRQ_Concat_dout 1 1 1 420
preplace netloc axi_dma_2_M_AXI_S2MM 1 0 3 30 140 NJ 140 1950
preplace netloc Processing_System|axi_dma_1_s2mm_introut 1 0 1 N
preplace netloc ps7_0_axi_periph_M01_AXI 1 1 1 1530
preplace netloc axi_dma_0_s2mm_introut 1 0 3 -50 90 NJ 90 1930
preplace netloc Processing_System|axi_dma_2_s2mm_introut 1 0 1 N
preplace netloc Processing_System|processing_system7_0_FCLK_RESET0_N 1 1 2 450 550 900
preplace netloc axi_dma_0_M_AXI_MM2S 1 0 3 -20 40 NJ 40 2010
preplace netloc processing_system7_0_FIXED_IO 1 1 1 1480
preplace netloc axi_dma_2_mm2s_introut 1 0 3 20 1230 NJ 1230 1940
preplace netloc axi_dma_0_mm2s_introut 1 0 3 -60 80 NJ 80 1940
preplace netloc Processing_System|ps7_0_axi_periph_M01_AXI 1 3 1 N
preplace netloc Processing_System|rst_ps7_0_100M_peripheral_aresetn 1 2 2 940 1190 NJ
preplace netloc axi_dma_0_M_AXI_S2MM 1 0 3 -10 50 NJ 50 2000
preplace netloc Processing_System|axi_dma_2_mm2s_introut 1 0 1 N
preplace netloc Processing_System|processing_system7_0_FCLK_CLK0 1 1 3 440 830 990 650 NJ
preplace netloc axi_dma_2_M_AXI_MM2S 1 0 3 20 130 NJ 130 1960
preplace netloc s_axis_data_1_1 1 0 2 -70J 240 1490J
preplace netloc processing_system7_0_FCLK_CLK0 1 1 1 1510
preplace netloc s_axis_data_0_1 1 0 2 -70J 220 NJ
preplace netloc axi_dma_2_M_AXIS_MM2S 1 2 1 2010J
preplace netloc axi_dma_0_M_AXIS_MM2S 1 2 1 NJ
preplace netloc ps7_0_axi_periph_M00_AXI 1 1 1 1500
preplace netloc Processing_System|Conn1 1 0 3 NJ 330 NJ 330 1010
preplace netloc Processing_System|axi_dma_0_mm2s_introut 1 0 1 N
preplace netloc axi_dma_1_mm2s_introut 1 0 3 -40 110 NJ 110 1980
levelinfo -pg 1 -90 300 1760 2040 -top -140 -bot 1320
levelinfo -hier Processing_System * 330 680 1160 *
",
}
